...
# Fetch a remote image with browser-like headers and a single retry to reduce 403 hotlink errors
# This does NOT fallback to local assets — it will raise on persistent failure so you can see the problem.
def fetch_image(url)
  ua = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0 Safari/537.36"
  opts = { "User-Agent" => ua, "Accept" => "image/*" }
  begin
    host = URI.parse(url).host
    opts["Referer"] = "https://#{host}" if host
...
file30 = fetch_image("https://avatars.githubusercontent.com/u/77808978?v=4")
file31 = fetch_image("https://avatars.githubusercontent.com/u/108654212?v=4")
file32 = fetch_image("https://avatars.githubusercontent.com/u/108351320?v=4")
...
file1 = fetch_image("https://takumi.koeln/wp-content/uploads/2021/10/ramen-koeln-2-shio.jpg")
file22 = fetch_image("https://res.cloudinary.com/qhai/image/upload/v1662630383/production/87bc54_710f936f47774a0589e6a7ff481a9c2d_mv2_aprpvk.webp")
file23 = fetch_image("https://res.cloudinary.com/qhai/image/upload/v1662630383/production/ramen-takumi-koeln-4_efgody.jpg")
...
file2 = fetch_image("https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=800")
...
file3 = fetch_image("https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=800")
...
file4 = fetch_image("https://images.unsplash.com/photo-1588137378633-dea1336ce1e2?w=800")
...
file5 = fetch_image("https://cdn.statically.io/img/www.aheadofthyme.com/f=auto//wp-content/uploads/2021/07/vietnamese-summer-rolls-with-chicken-2.jpg")
file40 = fetch_image("https://cdn.tgdd.vn/Files/2021/08/28/1378488/cach-lam-goi-cuon-bo-xao-sa-thom-lung-ngon-mieng-dai-ca-nha-202201051121002357.jpg")
file41 = fetch_image("https://www.resipis.de/wp-content/uploads/2016/07/vietnamesische-sommerrollen-mit-garnelen-und-nuoc-cham-1.jpg")
...
file6 = fetch_image("https://cheflolaskitchen.com/wp-content/uploads/2018/10/Jollof-Rice-55.jpg")
...
file7 = fetch_image("https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800")
...
file8 = fetch_image("https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=800")
...
file9 = fetch_image("https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800")
...
file10 = fetch_image("https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=800")
...
# attach remote image for bean soup (no fallback)
file11 = fetch_image("https://www.kuechengoetter.de/uploads/media/630x630/00/5760-gruener-bohneneintopf.jpg?v=1-0")
...
file12 = fetch_image("https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/delish-220823-hong-kong-french-toast-388-horizontal-rv-web-1662038739.jpg?crop=0.895xw:0.855xh;0.0646xw,0.128xh&resize=980:*")
file23 = fetch_image("https://imagesvc.meredithcorp.io/v3/mm/image?q=60&c=sc&poi=%5B711%2C451%5D&w=1582&h=791&url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F43%2F2022%2F03%2F08%2F7016-french-toast-mfs-010.jpg")
file24 = fetch_image("https://www.simplyrecipes.com/thmb/1r6e-oOPSGBkxbxY13tcRE1AvA8=/648x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-French-Toast-Lead-Shot-3b-c3a68a576a9548f5bd43cce3d2d7f4b7.jpg")
...
file13 = fetch_image("https://hips.hearstapps.com/del.h-cdn.co/assets/18/11/1520902273-shot-1-56.jpg?crop=1.0xw:1xh;center,top&resize=980:*")
...
file14 = fetch_image("https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/singleimagebug-korean-fried-chicken-1549305127.jpg?crop=1xw:0.9453781512605042xh;center,top&resize=980:*")
...
file15 = fetch_image("https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/delish-190828-beef-bourguignon-0154-portrait-pf-1568132096.jpg?crop=1xw:0.9994736842105263xh;center,top&resize=768:*&keepGifs=1")
...
file16 = fetch_image("https://cdn.loveandlemons.com/wp-content/uploads/2019/12/vegan-recipes.jpg")
...
file17 = fetch_image("https://www.thespruceeats.com/thmb/LzlC4zHWABM91kFC76Zl6RAZqkk=/3244x2433/smart/filters:no_upscale()/zucchinifritters-56a5b26b5f9b58b7d0de04f2.jpg")
...
file18 = fetch_image("https://veganuary.com/wp-content/uploads/2016/09/Caribbean-Tofu-2.jpg")
...
file19 = fetch_image("https://rainbowplantlife.com/wp-content/uploads/2020/11/peachblueberrrycobbler287of1029.jpg")
...
file20 = fetch_image("https://img.taste.com.au/1KNqPo-z/w720-h480-cfill-q80/taste/2021/10/tuscan-chicken-rissoles-recipe-174147-2.jpg")
...
file21 = fetch_image("https://sallysbakingaddiction.com/wp-content/uploads/2013/04/triple-chocolate-cake-4.jpg")
